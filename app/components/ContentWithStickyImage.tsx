          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-xl leading-8 text-gray-700">
                ...
                Lead in Sydney, Australia, with over 10 years experience
          ...
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
              <p>
                ...
                a business-critical project and they need someone to make sure
                that the team comes together to get it delivered. Most recently
                I was leading a team of 8 people at a large construction firm to
                help build out a first-of-its-kind platform for scoping and
                managing multi-million dollar construction projects.
              </p>
              <p className="mt-4">
                I help your team deliver their project; usually that involves
                defining solution architectures, overseeing and helping with the
                implementation details where needed, liaising with stakeholders,
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    With over 10 years commercial experience of driving web
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    in software engineering and I started as a junior developer
                    back in 2011. Since then I've done backend, frontend,
                    databases, (some) devops, and everything in between. I can
                    bring that holistic view of how a prodcut is built to your
                    project.
                  </span>
                </li>
              </ul>

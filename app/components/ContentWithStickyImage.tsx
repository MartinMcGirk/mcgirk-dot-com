...
const ContentWithStickyImage = () => {
  return (
    <div className="relative isolate overflow-hidden bg-white dark:bg-indigo-950 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 dark:text-blue-100 lg:max-w-lg">
              ...
              <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900 dark:text-blue-50">

  ...
  return (
    <div className="rounded-full grow-0 shrink-0 shadow-xl border-4 border-sky-600 overflow-hidden w-[100px] h-[100px] md:w-[300px] md:h-[300px] relative">
      ...
      <Image
        ...
        height={512}
        className={
          "hidden md:block max-w-screen-xl absolute -top-[30px] -left-[180px]"
        }
        style={{
          transitionTimingFunction: "ease",
          transitionDuration: "0.15s",
          transform: `translateY(${mouseCoords[1] * -20}px) translateX(${
            mouseCoords[0] * -20
          }px)`,
        }}
      />
      <Image
        ...
        height={512}
        className={
          "hidden md:block max-w-screen-xl absolute -top-[40px] -left-[180px]"
        }
        style={{
          transitionTimingFunction: "ease",
          transitionDuration: "0.15s",
          transform: `translateY(${mouseCoords[1] * -7}px) translateX(${
            mouseCoords[0] * -7
          }px)`,
        }}
      />
